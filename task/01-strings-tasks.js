...
function getCardId(value) {
    ...
    switch (value[value.split('').length-1]) {
        case '♣':
                return numberCard.indexOf(card);
        case '♦':
                return  +(numberCard.indexOf(card)) + 13;
        case '♥':
                return  +(numberCard.indexOf(card)) + 26;          
        case '♠':
                return  +(numberCard.indexOf(card)) + 39;          
    }
}
